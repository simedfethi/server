...
import com.avanquest.scibscrm.service.ProductCategoryQueryService;
...
/**
 * REST controller for managing {@link com.avanquest.scibscrm.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
public class ProductCategoryResource {
    ...
    public ResponseEntity<List<ProductCategory>> getAllProductCategories(
        ...
        Page<ProductCategory> page = productCategoryQueryService.findByCriteria(criteria, pageable);
